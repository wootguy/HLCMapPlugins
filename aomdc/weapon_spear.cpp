...
class CSpear : public CWeaponCustom {
	...
	void ItemPostFrame() override {
		...
		// stuff. Here I'm making it look more like the spear is the reason you get electrocuted.
	...
	bool Chargeup(int attackIdx, int* clip, bool leftHand, bool akimboFire) override {
		CBasePlayer* m_pPlayer = GetPlayer();
		if (!m_pPlayer)
			return false;
		...
		return CWeaponCustom::Chargeup(attackIdx, clip, leftHand, akimboFire);
	}
